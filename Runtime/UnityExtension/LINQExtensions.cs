...
namespace Shun_Utilities
{
    ...
    public static class LINQExtensions
    {
        ...
        public static T[] ShuffleCopy<T>(this T[] ts)
        {
        ...
        public static List<T> ShuffleCopy<T>(this List<T> ts)
        {
        ...
        public static void ShuffleReference<T>(this T[] list)
        {
        ...
        public static void ShuffleReference<T>(this IList<T> list)
        {
